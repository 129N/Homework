...
public class Name_List {
    ...
    private final String[] names = {
            ...
            "Alexander Simmons", "James Long", "Daniel Simmons", "Liam Butler","Yajuu Senpai","Noctis Luci's Chameleon", "Tidus chimpo","Iiyo Koiyo", "Matthew Perry", "Jackson Price", "Michael Price", "Henry Price", "Andrew Collins", "Benjamin Long",
            ...
            "Alexander Simmons", "Gabriel Price", "Liam Butler", "Emma Johnson", "Liam Smith", "Olivia Brown", "Noah Taylor", "Ava Martinez", "Isabella Williams", "Sophia Jones", "Mia Anderson", "Charlotte Garcia", "Amelia Davis",
            ...
            "Samuel Murphy", "Nicholas Gray", "Ethan Griffin", "Andrew Bailey", "William Long", "David Simmons", "Joseph Simmons", "Gabriel Perry", "Benjamin Green", "Caleb Baker","Matthew Perry", "Nathaniel Price", "Michael Price", "Daniel Simmons", "Andrew Collins", "Caleb Cox", "Jonathan Wood",
